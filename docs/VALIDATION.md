...
| Cooperación | Cinco procesos reales: anfitrión, navegación, ingeniería, clave incorrecta y puesto ocupado. Se verifican rechazo de conexiones, permisos, órdenes, movimiento y límites de presencia. |
...
| Interfaz | 39 comprobaciones, 0 fallos. Botón de piloto automático con efecto real, ocho puestos, límites de las pantallas, colisión del suelo en siete espacios y ciclo de edición/guardado/reapertura de una misión. |
...
| Linux | Exportación y ejecución gráfica del binario autónomo. Ocho capturas de 1600 × 900 revisadas visualmente. |
| Windows | Exportación PE x86_64. El flujo de GitHub añade una comprobación de arranque del ejecutable en Windows Server 2022 antes de publicar la versión. Su resultado aparece en Actions. |
| Recursos | Fuente Blender editable, veinte GLB comprobados contra SHA-256, ocho PNG y ZIP con CRC y SHA-256. |
