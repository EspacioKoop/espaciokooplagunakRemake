# Itsaso · nave principal

[← Biblioteca](../../ASSET_LIBRARY.md) · [Colección](../base.md) · [JSON para agentes](../../asset_library.json)

<img src="../../images/asset_library/base--itsaso.png" alt="Modelo 3D real: Itsaso · nave principal" width="560">

Recurso de biblioteca; consultar su guía.

[Source](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/art/blender/lagunak_assets.blend) · [Runtime](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/itsaso.glb) · [Manifest](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/manifest.json) · [Guide](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/AUTHORING.md)

| Campo | Valor |
| --- | --- |
| ID estable | base/itsaso |
| Colección / categoría | base / Naves |
...
| Dimensiones X × Y × Z | 9.85 × 4.3 × 20.0 |
| Origen / pivote | consult_source_and_sockets |
| Triángulos del GLB | 3988 |
| Licencia | MIT |
...
**Materiales:** `Titanio cepillado`, `Cerámica · Marfil`, `Estructura · Grafito`, `Pantalla · Aguamarina`, `Seguridad · Ámbar`, `Luz · Hielo`, `Alarma · Coral`.
