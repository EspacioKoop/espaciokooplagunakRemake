...
<img src="../../images/asset_library/base--quarters_room.png" alt="Modelo 3D real: Camarotes" width="560">

Recurso de biblioteca; consultar su guía.

[Source](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/art/blender/lagunak_assets.blend) · [Runtime](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/quarters_room.glb) · [Manifest](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/manifest.json) · [Guide](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/AUTHORING.md)

| Campo | Valor |
| --- | --- |
| ID estable | base/quarters_room |
...
```text
res://assets/models/quarters_room.glb
```
...
**Materiales:** `Titanio cepillado`, `Goma y suelo`, `Estructura · Grafito`, `Cerámica · Marfil`, `Luz · Cálida`, `Luz · Hielo`, `Seguridad · Ámbar`, `Textil · Azul`.
