...
<img src="../../images/asset_library/base--cargo_room.png" alt="Modelo 3D real: Bodega de carga" width="560">

Recurso de biblioteca; consultar su guía.

[Source](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/art/blender/lagunak_assets.blend) · [Runtime](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/cargo_room.glb) · [Manifest](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/manifest.json) · [Guide](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/AUTHORING.md)

| Campo | Valor |
| --- | --- |
| ID estable | base/cargo_room |
...
```text
res://assets/models/cargo_room.glb
```
...
**Materiales:** `Seguridad · Ámbar`, `Goma y suelo`, `Estructura · Grafito`, `Cerámica · Marfil`, `Titanio cepillado`, `Luz · Cálida`, `Luz · Hielo`, `Pantalla · Aguamarina`.
