...
<img src="https://raw.githubusercontent.com/EspacioKoop/espaciokooplagunakRemake/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/images/fieldkit_pack/jostun_repair.png" alt="Modelo 3D real: Jostun · reparador" width="560">

Herramienta de reparación ficticia con pinzas y cartucho de servicio.

[Source](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/art/blender/fieldkit_pack/jostun_repair.blend) · [Runtime](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/fieldkit_pack/jostun_repair.glb) · [Manifest](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/fieldkit_pack/manifest.json) · [Scene](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/asset_lab/fieldkit_pack/instances/jostun_repair.tscn) · [Guide](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/FIELDKIT_ASSET_PACK.md) · [Viewer](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/asset_lab/fieldkit_pack/viewer.tscn)

| Campo | Valor |
| --- | --- |
| ID estable | fieldkit/jostun_repair |
...
| Dimensiones X × Y × Z | 0.205312 × 0.3274 × 0.588277 |
| Origen / pivote | grip |
| Triángulos del GLB | 2964 |
| Licencia | MIT |
...
```text
res://assets/models/fieldkit_pack/jostun_repair.glb
```
...
**Materiales:** `Fieldkit_alloy`, `Fieldkit_brass`, `Fieldkit_graphite`, `Fieldkit_amber`, `Fieldkit_chalk`, `Fieldkit_blue`, `Fieldkit_cyan`.

**Anclajes:** `socket_contact_left`, `socket_contact_right`, `socket_effect`, `socket_grip`, `socket_offhand`.
