# Arnasa · respirador portátil

[← Biblioteca](../../ASSET_LIBRARY.md) · [Colección](../itsasargi.md) · [JSON para agentes](../../asset_library.json)

<img src="https://raw.githubusercontent.com/EspacioKoop/espaciokooplagunakRemake/cae594662d17157b296b6d4c79a881b666093ee1/docs/images/itsasargi_pack/oxygen_rebreather.png" alt="Modelo 3D real: Arnasa · respirador portátil" width="560">

Dos depósitos, regulador, máscara y tubo; accesorio de ciencia ficción.

[Source](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/cae594662d17157b296b6d4c79a881b666093ee1/art/blender/itsasargi_pack/oxygen_rebreather.blend) · [Runtime](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/cae594662d17157b296b6d4c79a881b666093ee1/game/assets/models/itsasargi_pack/oxygen_rebreather.glb) · [Manifest](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/cae594662d17157b296b6d4c79a881b666093ee1/game/assets/models/itsasargi_pack/manifest.json) · [Guide](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/cae594662d17157b296b6d4c79a881b666093ee1/docs/ITSASARGI_ASSET_PACK.md) · [Viewer](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/cae594662d17157b296b6d4c79a881b666093ee1/game/asset_lab/itsasargi_pack/viewer.tscn)

| Campo | Valor |
| --- | --- |
| ID estable | itsasargi/oxygen_rebreather |
| Colección / categoría | itsasargi / Herramientas |
| Versión del recurso | 1 |
| Estado documental | Publicado en rama de entrega; no atribuido a main |
| Unidades | metres |
| Ejes | +X right / +Y up / -Z forward |
| Dimensiones X × Y × Z | 0.497 × 0.509 × 0.5535 |
| Origen / pivote | consult_source_and_sockets |
| Triángulos del GLB | 4908 |
| Licencia | MIT |
...
```text
res://assets/models/itsasargi_pack/oxygen_rebreather.glb
```
...
**Materiales:** `I_cyan_emitter`, `I_graphite_grip`, `I_ceramic_ivory`, `I_deep_petrol`, `I_safety_amber`, `I_titanium`.

**Anclajes:** `socket_mask`, `socket_back_mount`, `socket_grip_primary`.
