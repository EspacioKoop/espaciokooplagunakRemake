...
<img src="https://raw.githubusercontent.com/EspacioKoop/espaciokooplagunakRemake/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/images/frontier_pack/mineral_cluster.png" alt="Modelo 3D real: Veta de cristales" width="560">

Recurso mineral con cinco cristales y base rocosa.

[Source](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/art/blender/frontier_pack/sources/mineral_cluster.blend) · [Runtime](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/frontier_pack/mineral_cluster.glb) · [Manifest](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/frontier_pack/manifest.json) · [Guide](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/FRONTIER_ASSET_PACK.md)

| Campo | Valor |
| --- | --- |
| ID estable | frontier/mineral_cluster |
...
| Dimensiones X × Y × Z | 1.23638 × 1.41504 × 1.06 |
| Origen / pivote | consult_source_and_sockets |
| Triángulos del GLB | 230 |
| Licencia | MIT |
...
```text
res://assets/models/frontier_pack/mineral_cluster.glb
```
...
**Materiales:** `Carbon`, `Mineral_Violet`, `Emitter_Cyan`, `Crew_Teal`.
