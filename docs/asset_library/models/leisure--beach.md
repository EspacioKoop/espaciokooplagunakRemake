...
<img src="../../images/asset_library/leisure--beach.png" alt="Modelo 3D real: Playa" width="560">
...
| Triángulos del GLB | 20200 |
| Licencia | MIT |
| Colisión | consult_pack |
| LOD | consult_pack |
| Submodelo dentro del GLB compartido | beach |
...
**Materiales:** `Brushed brass`, `Book paper`, `Oiled chestnut`, `Sculpture · warm limestone`, `Deep blue enamel`, `Gallery · pale stone`, `Warm light`, `Sand`, `Wind grass`, `Water`, `Booth red`, `Smoked blue glazing`.
