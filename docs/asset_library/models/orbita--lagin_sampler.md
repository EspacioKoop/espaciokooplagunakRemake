# Lagin · recolector geológico

[← Biblioteca](../../ASSET_LIBRARY.md) · [Colección](../orbita_player_support.md) · [JSON para agentes](../../asset_library.json)

<img src="https://raw.githubusercontent.com/EspacioKoop/espaciokooplagunakRemake/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/images/orbita_pack/player_batch/lagin_sampler.png" alt="Modelo 3D real: Lagin · recolector geológico" width="560">

Herramienta de muestreo con sonda extensible y carrusel de recipientes sellados.

[Source](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/art/blender/orbita_pack/player_batch/lagin_sampler.blend) · [Runtime](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/orbita_pack/player_batch/lagin_sampler.glb) · [Manifest](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/orbita_pack/player_batch/manifest.json) · [Guide](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/ORBITA_PLAYER_BATCH.md) · [Viewer](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/asset_lab/orbita_pack/player_batch.tscn)

| Campo | Valor |
| --- | --- |
| ID estable | orbita/lagin_sampler |
...
| Dimensiones X × Y × Z | 0.257 × 0.3205 × 0.537 |
| Origen / pivote | consult_source_and_sockets |
| Triángulos del GLB | 2492 |
| Licencia | MIT |
...
```text
res://assets/models/orbita_pack/player_batch/lagin_sampler.glb
```
...
**Materiales:** `Orbita_amber`, `Orbita_graphite`, `Orbita_alloy`, `Orbita_ceramic`, `Orbita_teal`, `Orbita_cyan`, `Orbita_glass`, `Orbita_gold`.

**Anclajes:** `socket_sample_tip`, `socket_belt`, `socket_canister`, `socket_grip`.
