...
<img src="../../images/asset_library/base--hallway.png" alt="Modelo 3D real: Pasillo de la nave" width="560">

Recurso de biblioteca; consultar su guía.

[Source](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/art/blender/lagunak_assets.blend) · [Runtime](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/hallway.glb) · [Manifest](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/manifest.json) · [Guide](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/AUTHORING.md)

| Campo | Valor |
| --- | --- |
| ID estable | base/hallway |
...
| Dimensiones X × Y × Z | 6.0 × 4.64 × 42.0 |
| Origen / pivote | consult_source_and_sockets |
| Triángulos del GLB | 7452 |
| Licencia | MIT |
...
**Materiales:** `Titanio cepillado`, `Goma y suelo`, `Estructura · Grafito`, `Luz · Cálida`, `Luz · Hielo`.
