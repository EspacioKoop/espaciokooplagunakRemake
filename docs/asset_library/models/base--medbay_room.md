...
<img src="../../images/asset_library/base--medbay_room.png" alt="Modelo 3D real: Enfermería" width="560">

Recurso de biblioteca; consultar su guía.

[Source](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/art/blender/lagunak_assets.blend) · [Runtime](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/medbay_room.glb) · [Manifest](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/manifest.json) · [Guide](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/AUTHORING.md)

| Campo | Valor |
| --- | --- |
| ID estable | base/medbay_room |
...
| Dimensiones X × Y × Z | 14.3 × 4.82 × 14.89 |
| Origen / pivote | consult_source_and_sockets |
| Triángulos del GLB | 14904 |
| Licencia | MIT |
...
```text
res://assets/models/medbay_room.glb
```
...
**Materiales:** `Cerámica · Marfil`, `Goma y suelo`, `Estructura · Grafito`, `Titanio cepillado`, `Luz · Cálida`, `Luz · Hielo`, `Seguridad · Ámbar`, `Textil · Azul`, `Pantalla · Aguamarina`.
