...
<img src="../../images/asset_library/leisure--museum_hall.png" alt="Modelo 3D real: Sala del museo" width="560">
...
| Campo | Valor |
| --- | --- |
| ID estable | leisure/museum_hall |
...
| Triángulos del GLB | 117340 |
| Licencia | MIT |
| Colisión | consult_pack |
| LOD | consult_pack |
| Submodelo dentro del GLB compartido | museum_hall |
...
**Materiales:** `Brushed brass`, `Sea glass`, `Book paper`, `Oiled chestnut`, `Sculpture · warm limestone`, `Deep blue enamel`, `Gallery · pale stone`, `Warm light`.
