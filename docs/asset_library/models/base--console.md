...
<img src="../../images/asset_library/base--console.png" alt="Modelo 3D real: Consola de control" width="560">

Recurso de biblioteca; consultar su guía.

[Source](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/art/blender/lagunak_assets.blend) · [Runtime](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/console.glb) · [Manifest](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/manifest.json) · [Guide](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/AUTHORING.md)

| Campo | Valor |
| --- | --- |
| ID estable | base/console |
...
| Dimensiones X × Y × Z | 1.85 × 1.5605 × 0.92 |
| Origen / pivote | consult_source_and_sockets |
| Triángulos del GLB | 1512 |
| Licencia | MIT |
...
**Materiales:** `Seguridad · Ámbar`, `Estructura · Grafito`, `Titanio cepillado`, `Pantalla · Aguamarina`, `Goma y suelo`, `Luz · Hielo`, `Cerámica · Marfil`, `Luz · Cálida`.
