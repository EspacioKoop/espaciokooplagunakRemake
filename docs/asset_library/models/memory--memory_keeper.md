# Guardiana del recuerdo

[← Biblioteca](../../ASSET_LIBRARY.md) · [Colección](../memory.md) · [JSON para agentes](../../asset_library.json)

<img src="../../images/asset_library/memory--memory_keeper.png" alt="Modelo 3D real: Guardiana del recuerdo" width="560">
...
| Campo | Valor |
| --- | --- |
| ID estable | memory/memory_keeper |
...
| Triángulos del GLB | 1356 |
| Licencia | MIT |
| Colisión | consult_pack |
| LOD | consult_pack |
| Submodelo dentro del GLB compartido | memory_keeper |
