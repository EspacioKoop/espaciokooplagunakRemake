...
<img src="../../images/asset_library/memory--memory_prism.png" alt="Modelo 3D real: Prisma del recuerdo" width="560">
...
| Campo | Valor |
| --- | --- |
| ID estable | memory/memory_prism |
...
| Triángulos del GLB | 680 |
| Licencia | MIT |
| Colisión | consult_pack |
| LOD | consult_pack |
| Submodelo dentro del GLB compartido | memory_prism |
