# Estación espacial exterior

[← Biblioteca](../../ASSET_LIBRARY.md) · [Colección](../base.md) · [JSON para agentes](../../asset_library.json)

<img src="../../images/asset_library/base--station.png" alt="Modelo 3D real: Estación espacial exterior" width="560">

Recurso de biblioteca; consultar su guía.

[Source](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/art/blender/lagunak_assets.blend) · [Runtime](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/station.glb) · [Manifest](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/manifest.json) · [Guide](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/AUTHORING.md)

| Campo | Valor |
| --- | --- |
| ID estable | base/station |
| Colección / categoría | base / Utilería e infraestructura |
...
| Dimensiones X × Y × Z | 34.38 × 13.0 × 34.0 |
| Origen / pivote | consult_source_and_sockets |
| Triángulos del GLB | 3408 |
| Licencia | MIT |
...
**Materiales:** `Luz · Hielo`, `Cerámica · Marfil`, `Estructura · Grafito`, `Seguridad · Ámbar`, `Titanio cepillado`, `Pantalla · Aguamarina`, `Luz · Cálida`.
