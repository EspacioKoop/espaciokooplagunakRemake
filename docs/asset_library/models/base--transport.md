...
<img src="../../images/asset_library/base--transport.png" alt="Modelo 3D real: Nave de transporte" width="560">

Recurso de biblioteca; consultar su guía.

[Source](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/art/blender/lagunak_assets.blend) · [Runtime](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/transport.glb) · [Manifest](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/manifest.json) · [Guide](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/AUTHORING.md)

| Campo | Valor |
| --- | --- |
| ID estable | base/transport |
...
| Dimensiones X × Y × Z | 5.4 × 1.78 × 8.15 |
| Origen / pivote | consult_source_and_sockets |
| Triángulos del GLB | 844 |
| Licencia | MIT |
...
```text
res://assets/models/transport.glb
```
...
**Materiales:** `Pantalla · Aguamarina`, `Cerámica · Marfil`, `Titanio cepillado`, `Seguridad · Ámbar`, `Luz · Hielo`.
