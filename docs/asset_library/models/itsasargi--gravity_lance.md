# Indar · lanza gravitatoria

[← Biblioteca](../../ASSET_LIBRARY.md) · [Colección](../itsasargi.md) · [JSON para agentes](../../asset_library.json)

<img src="https://raw.githubusercontent.com/EspacioKoop/espaciokooplagunakRemake/cae594662d17157b296b6d4c79a881b666093ee1/docs/images/itsasargi_pack/gravity_lance.png" alt="Modelo 3D real: Indar · lanza gravitatoria" width="560">

Arma visual ficticia de dos manos con emisores abiertos y anillos.

[Source](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/cae594662d17157b296b6d4c79a881b666093ee1/art/blender/itsasargi_pack/gravity_lance.blend) · [Runtime](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/cae594662d17157b296b6d4c79a881b666093ee1/game/assets/models/itsasargi_pack/gravity_lance.glb) · [Manifest](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/cae594662d17157b296b6d4c79a881b666093ee1/game/assets/models/itsasargi_pack/manifest.json) · [Guide](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/cae594662d17157b296b6d4c79a881b666093ee1/docs/ITSASARGI_ASSET_PACK.md) · [Viewer](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/cae594662d17157b296b6d4c79a881b666093ee1/game/asset_lab/itsasargi_pack/viewer.tscn)

| Campo | Valor |
| --- | --- |
| ID estable | itsasargi/gravity_lance |
| Colección / categoría | itsasargi / Armas ficticias |
| Versión del recurso | 1 |
| Estado documental | Publicado en rama de entrega; no atribuido a main |
| Unidades | metres |
| Ejes | +X right / +Y up / -Z forward |
| Dimensiones X × Y × Z | 0.342 × 0.4565 × 1.305164 |
| Origen / pivote | consult_source_and_sockets |
| Triángulos del GLB | 4356 |
| Licencia | MIT |
...
```text
res://assets/models/itsasargi_pack/gravity_lance.glb
```
...
**Materiales:** `I_titanium`, `I_deep_petrol`, `I_graphite_grip`, `I_ceramic_ivory`, `I_safety_amber`, `I_cyan_emitter`, `I_prism_emitter`.

**Anclajes:** `socket_grip_primary`, `socket_grip_support`, `socket_muzzle`, `socket_stock`.
