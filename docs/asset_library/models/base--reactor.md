...
<img src="../../images/asset_library/base--reactor.png" alt="Modelo 3D real: Reactor" width="560">

Recurso de biblioteca; consultar su guía.

[Source](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/art/blender/lagunak_assets.blend) · [Runtime](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/reactor.glb) · [Manifest](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/manifest.json) · [Guide](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/AUTHORING.md)

| Campo | Valor |
| --- | --- |
| ID estable | base/reactor |
...
| Dimensiones X × Y × Z | 3.4 × 4.35 × 3.4 |
| Origen / pivote | consult_source_and_sockets |
| Triángulos del GLB | 2456 |
| Licencia | MIT |
...
**Materiales:** `Estructura · Grafito`, `Luz · Hielo`, `Titanio cepillado`, `Seguridad · Ámbar`.
