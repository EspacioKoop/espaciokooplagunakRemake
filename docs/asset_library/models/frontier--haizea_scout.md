...
<img src="https://raw.githubusercontent.com/EspacioKoop/espaciokooplagunakRemake/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/images/frontier_pack/haizea_scout.png" alt="Modelo 3D real: Haizea / exploradora" width="560">

Reconocimiento, doble motor y sensores de proa.

[Source](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/art/blender/frontier_pack/sources/haizea_scout.blend) · [Runtime](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/frontier_pack/haizea_scout.glb) · [Manifest](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/frontier_pack/manifest.json) · [Guide](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/FRONTIER_ASSET_PACK.md)

| Campo | Valor |
| --- | --- |
| ID estable | frontier/haizea_scout |
...
| Dimensiones X × Y × Z | 8.99171 × 2.24581 × 15.0 |
| Origen / pivote | consult_source_and_sockets |
| Triángulos del GLB | 4396 |
| Licencia | MIT |
...
```text
res://assets/models/frontier_pack/haizea_scout.glb
```
...
**Materiales:** `Hull_Slate`, `Opaque_Visor`, `Ceramic_Ivory`, `Brushed_Titanium`, `Carbon`, `Emitter_Cyan`, `Crew_Teal`.

**Anclajes:** `Socket_Cockpit`, `Socket_Dock`, `Socket_Engine`, `Socket_Engine_02`, `Socket_Forward`.
