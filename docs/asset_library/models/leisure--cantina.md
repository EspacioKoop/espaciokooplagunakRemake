...
<img src="../../images/asset_library/leisure--cantina.png" alt="Modelo 3D real: Cantina" width="560">
...
| Triángulos del GLB | 3112 |
| Licencia | MIT |
| Colisión | consult_pack |
| LOD | consult_pack |
| Submodelo dentro del GLB compartido | cantina |
...
**Materiales:** `Brushed brass`, `Sea glass`, `Oiled chestnut`, `Deep blue enamel`, `Gallery · pale stone`, `Warm light`.
