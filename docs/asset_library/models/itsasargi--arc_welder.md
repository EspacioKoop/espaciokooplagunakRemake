# Lotu · soldador de arco

[← Biblioteca](../../ASSET_LIBRARY.md) · [Colección](../itsasargi.md) · [JSON para agentes](../../asset_library.json)

<img src="https://raw.githubusercontent.com/EspacioKoop/espaciokooplagunakRemake/cae594662d17157b296b6d4c79a881b666093ee1/docs/images/itsasargi_pack/arc_welder.png" alt="Modelo 3D real: Lotu · soldador de arco" width="560">

Colimador retráctil y batería extraíble visual; reparación ficticia.

[Source](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/cae594662d17157b296b6d4c79a881b666093ee1/art/blender/itsasargi_pack/arc_welder.blend) · [Runtime](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/cae594662d17157b296b6d4c79a881b666093ee1/game/assets/models/itsasargi_pack/arc_welder.glb) · [Manifest](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/cae594662d17157b296b6d4c79a881b666093ee1/game/assets/models/itsasargi_pack/manifest.json) · [Guide](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/cae594662d17157b296b6d4c79a881b666093ee1/docs/ITSASARGI_ASSET_PACK.md) · [Viewer](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/cae594662d17157b296b6d4c79a881b666093ee1/game/asset_lab/itsasargi_pack/viewer.tscn)

| Campo | Valor |
| --- | --- |
| ID estable | itsasargi/arc_welder |
...
| Dimensiones X × Y × Z | 0.226 × 0.404 × 0.5675 |
| Origen / pivote | consult_source_and_sockets |
| Triángulos del GLB | 2972 |
| Licencia | MIT |
...
```text
res://assets/models/itsasargi_pack/arc_welder.glb
```
...
**Materiales:** `I_cyan_emitter`, `I_ceramic_ivory`, `I_titanium`, `I_safety_amber`, `I_deep_petrol`, `I_graphite_grip`.

**Anclajes:** `socket_effect_arc`, `socket_battery`, `socket_grip_primary`.
