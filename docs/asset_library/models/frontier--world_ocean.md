...
<img src="https://raw.githubusercontent.com/EspacioKoop/espaciokooplagunakRemake/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/images/frontier_pack/world_ocean.png" alt="Modelo 3D real: Urdin / oceánico" width="560">

Globo de océanos, archipiélagos y nubes estilizadas.

[Source](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/art/blender/frontier_pack/sources/world_ocean.blend) · [Runtime](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/frontier_pack/world_ocean.glb) · [Manifest](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/frontier_pack/manifest.json) · [Guide](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/FRONTIER_ASSET_PACK.md)

| Campo | Valor |
| --- | --- |
| ID estable | frontier/world_ocean |
...
| Dimensiones X × Y × Z | 2.01083 × 2.0 × 2.013 |
| Origen / pivote | consult_source_and_sockets |
| Triángulos del GLB | 9882 |
| Licencia | MIT |
...
```text
res://assets/models/frontier_pack/world_ocean.glb
```
...
**Materiales:** `World_Vertex_PBR`, `Ceramic_Ivory`.
