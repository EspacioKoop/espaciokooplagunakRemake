...
<img src="../../images/asset_library/leisure--terrace.png" alt="Modelo 3D real: Terraza" width="560">
...
| Triángulos del GLB | 852 |
| Licencia | MIT |
| Colisión | consult_pack |
| LOD | consult_pack |
| Submodelo dentro del GLB compartido | terrace |
...
**Materiales:** `Brushed brass`, `Sea glass`, `Oiled chestnut`, `Gallery · pale stone`.
