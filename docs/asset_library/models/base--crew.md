...
<img src="../../images/asset_library/base--crew.png" alt="Modelo 3D real: Tripulante base" width="560">

Recurso de biblioteca; consultar su guía.

[Source](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/art/blender/lagunak_assets.blend) · [Runtime](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/crew.glb) · [Manifest](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/manifest.json) · [Guide](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/AUTHORING.md)

| Campo | Valor |
| --- | --- |
| ID estable | base/crew |
| Colección / categoría | base / Avatares y tripulación |
...
| Dimensiones X × Y × Z | 0.919 × 1.89 × 0.485 |
| Origen / pivote | consult_source_and_sockets |
| Triángulos del GLB | 1052 |
| Licencia | MIT |
...
**Materiales:** `Cerámica · Marfil`, `Pantalla · Aguamarina`, `Seguridad · Ámbar`, `Estructura · Grafito`, `Titanio cepillado`.
