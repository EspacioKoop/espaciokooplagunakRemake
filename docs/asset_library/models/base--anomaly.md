...
<img src="../../images/asset_library/base--anomaly.png" alt="Modelo 3D real: Anomalía espacial" width="560">

Recurso de biblioteca; consultar su guía.

[Source](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/art/blender/lagunak_assets.blend) · [Runtime](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/anomaly.glb) · [Manifest](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/game/assets/models/manifest.json) · [Guide](https://github.com/EspacioKoop/espaciokooplagunakRemake/blob/9e2401d7dcb4719dc831fd84093a6f9640453687/docs/AUTHORING.md)

| Campo | Valor |
| --- | --- |
| ID estable | base/anomaly |
...
| Dimensiones X × Y × Z | 8.5552 × 8.0315 × 8.4035 |
| Origen / pivote | consult_source_and_sockets |
| Triángulos del GLB | 1172 |
| Licencia | MIT |
...
**Materiales:** `Luz · Hielo`, `Pantalla · Aguamarina`.
