...
Al recuperar el trabajo faltaban escenarios, facciones y variantes de naves, mesas de ocio, asistencia de personajes, museo y playa, bestiario, editor de personajes y plataformas/herramientas del original. Las ampliaciones ya incorporan las tres mesas, museo, playa y otros espacios; las variantes pendientes se detallan en la matriz de paridad. La asistencia recuperada se simplificó a una orden con coste de energía. Esa simplificación se ha sustituido por cuatro retos nativos y propuestas consumibles, con comprobaciones de autoridad y caducidad. Los enfoques de personaje siguen pendientes. La integración Foundry 13 se limita a consulta y bitácora; las órdenes se ejecutan desde el juego.
...
Las reglas de las mesas se contrastaron con los motores de póker, blackjack y dados y con los contratos de sesión de la referencia. La implementación nueva usa naipes enteros, evaluación de combinaciones, coordinación nativa y proyecciones ENet por destinatario. Incluye botes secundarios, blackjack 3:2, unos comodín, espectadores y reconexión; no incorpora el código JavaScript del original. La reconstrucción de las animaciones y proyecciones 3D de esas mesas sigue abierta.
