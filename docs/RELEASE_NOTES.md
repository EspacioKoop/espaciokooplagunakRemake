...
La ampliación añade operaciones de puestos y cuatro minijuegos de asistencia con propuestas consumibles. El README incluye dieciocho capturas reales del ejecutable. Las pruebas de núcleo, operaciones y asistencia suman 320 comprobaciones; también se prueban interfaz, HTTP y cinco procesos de red.
